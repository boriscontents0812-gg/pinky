...
export default function Home() {
  return (
    <main className="min-h-screen kree8-canvas flex flex-col items-center justify-start px-4 pt-3 sm:pt-6 pb-12 relative overflow-x-hidden antialiased">
      {/* Subtle ambient background glows from the Teal & Coral palette */}
      <div
      ...
      <div className="flex flex-col flex-1 max-w-[390px] w-full mx-auto justify-start relative z-10">
        {/* Top Site Brand Header */}
        <header className="w-full flex items-center justify-center gap-1.5 pt-1 pb-1.5">
          <Image
            src="/icon.svg"
            alt="pinkyshoots"
            width={18}
        ...
        <div className="pt-5 pb-2 text-center">
          ...
          {/* Subheadline matching Kree8 medium leading-[160%] tracking-[-0.018em] */}
